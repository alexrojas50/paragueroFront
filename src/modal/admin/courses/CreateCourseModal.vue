  ...
  <q-dialog v-model="card">
    <q-card class="my-card">
      ...
      <q-card-actions align="right">
        <q-btn type="submit" flat color="primary" label="Crear Curso" @click="createCourse"
...
const createCourse = async () => {
  ...
  try {
    ...
    await api.post('/course', { courseName: courseName.value, courseTeacher: courseTeacher.value, courseHours: courseHour.value, courseDescription: courseDescription.value })
    Swal.fire({
      title: "Creado",
