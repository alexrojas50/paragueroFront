  ...
  <q-dialog v-model="card">
    <q-card class="my-card">
      <q-card-section class="q-pt-md">
        <div class="col text-h6 ellipsis">Elimina un Profesor</div>
      </q-card-section>

      <q-card-section class="q-pt-md">
        <div class="col text-h7 ellipsis">
          ¿Seguro que quieres eliminar al profesor {{ user.name }}?
        </div>
      </q-card-section>
      ...
      <q-card-actions align="right" class="row justify-around">
        ...
        <q-btn color="red" label="Eliminar Profesor" @click="close(true)" />
      </q-card-actions>
    </q-card>
  </q-dialog>
</template>
